...
@Component({
  ...
  template: `
    <div class="controls-container mt-8 w-full max-w-[340px] mx-auto relative select-none">
      <!-- Label -->
      <div class="absolute top-[-30px] left-4 flex gap-2 items-center opacity-80">
         <div class="w-2 h-2 rounded-full border border-[#306230]"></div>
         <span class="text-[#306230] italic font-bold tracking-wider text-[10px] font-sans">PHONES</span>
      </div>
      ...
      <div class="flex justify-between items-end px-2 pb-4">
        ...
        <!-- A/B Buttons -->
        <div class="action-buttons flex gap-5 transform -rotate-12 translate-y-[-10px] bg-gray-300/10 rounded-full px-4 py-2">
          <div class="flex flex-col items-center gap-1 group">
            ...
            <span class="text-[#306230] font-bold text-sm tracking-widest font-sans emboss">B</span>
          </div>
          <div class="flex flex-col items-center gap-1 mt-[-15px] group">
            ...
            <span class="text-[#306230] font-bold text-sm tracking-widest font-sans emboss">A</span>
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-center gap-6 mt-4">
        <div class="flex flex-col items-center gap-1">
          ...
          <span class="text-[#306230] font-bold text-[10px] tracking-widest mt-1 font-sans emboss">SELECT</span>
        </div>
        <div class="flex flex-col items-center gap-1">
          <button class="w-14 h-3 bg-gray-600 rounded-full transform rotate-[25deg] shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] active:bg-gray-800 border border-gray-500"
                  (mousedown)="onInput('START', $event)" (touchstart)="onInput('START', $event)"></button>
          <span class="text-[#306230] font-bold text-[10px] tracking-widest mt-1 font-sans emboss">START</span>
        </div>
      </div>
